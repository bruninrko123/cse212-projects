...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: in the Enqueue function, changed _queue.Insert(0, person); to be "_queue.Add(person);"
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:  Added else if statement to care handle size 0
    ...
    // Defect(s) Found: modified else if statement so that it handles both negative and 0 sizes of queue.
